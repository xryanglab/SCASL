...
It usually takes less than twenty minutes to complete the environment configuration. It should be noted that if leafcutter cannot be downloaded successfully with conda, you can also consider using source code and make sure to change the path of leafcutter in leafcutter/scripts/bam2junc.sh.
```bash
