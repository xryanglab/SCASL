...
As an example of configuration file, `configs/srr.yaml` and `data/bam` provides a minimized version of SRR dataset. You can also choose to use more cell data (from TNBC-2) in `data/junction` for testing.
